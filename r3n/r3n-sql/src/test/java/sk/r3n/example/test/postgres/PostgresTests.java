...
public class PostgresTests {
    ...
    public void init() {
        ...
        try {
            ...
            SqlUtil.runSqlScript(connection, PostgresTests.class.getResourceAsStream("/clean_postgres.sql"));
            SqlUtil.runSqlScript(connection, PostgresTests.class.getResourceAsStream("/install_postgres.sql"));
