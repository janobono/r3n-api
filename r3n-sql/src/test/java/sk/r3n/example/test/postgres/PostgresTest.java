...
public class PostgresTest {
    ...
    private void insertTest(Connection connection) throws SQLException, IOException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Insert insert = new Insert().INTO(TABLE.T_BASE_TYPES(), T_BASE_TYPES.columns()).VALUES(row).RETURNING(T_BASE_TYPES.ID());
            ...
            for (int j = 0; j < 10; j++) {
                ...
                insert = new Insert().INTO(TABLE.T_JOIN(), T_JOIN.columns()).VALUES(row);
