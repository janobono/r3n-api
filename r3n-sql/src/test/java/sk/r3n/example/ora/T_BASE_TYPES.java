...
public class T_BASE_TYPES implements Serializable {
    ...
    public static Column T_STRING_CLOB() {
        return new Column("t_string_clob", TABLE.T_BASE_TYPES(), DataType.STRING);
    }

    public static Column T_STRING_CLOB(String alias) {
        return new Column("t_string_clob", TABLE.T_BASE_TYPES(alias), DataType.STRING);
    }

    public static Column T_STRING_VARCHAR2() {
        return new Column("t_string_varchar2", TABLE.T_BASE_TYPES(), DataType.STRING);
    }

    public static Column T_STRING_VARCHAR2(String alias) {
        return new Column("t_string_varchar2", TABLE.T_BASE_TYPES(alias), DataType.STRING);
    }
    ...
    public static Column[] columns() {
        return new Column[]{ID(), T_SHORT(), T_INTEGER(), T_LONG(), T_BIG_DECIMAL(), T_STRING_CHAR(), T_STRING_CLOB(), T_STRING_VARCHAR2(), T_STRING_SCDF(), T_BLOB(), T_TIME_STAMP(), T_DATE(), T_BOOLEAN()};
    }

    public static Column[] columns(String alias) {
        return new Column[]{ID(alias), T_SHORT(alias), T_INTEGER(alias), T_LONG(alias), T_BIG_DECIMAL(alias), T_STRING_CHAR(alias), T_STRING_CLOB(alias), T_STRING_VARCHAR2(alias), T_STRING_SCDF(alias), T_BLOB(alias), T_TIME_STAMP(alias), T_DATE(alias), T_BOOLEAN(alias)};
    }
}
