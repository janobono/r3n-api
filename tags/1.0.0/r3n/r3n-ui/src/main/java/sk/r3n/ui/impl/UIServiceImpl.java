...
public class UIServiceImpl implements UIService {
    ...
    protected void activate(ComponentContext context) {
        this.idActionService = (IdActionService) context.locateService("IdActionService");
        ...
        idActionService.add(UIService.class.getCanonicalName(), ACTION_PREVIOUS);
        ...
        idActionService.add(UIService.class.getCanonicalName(), ACTION_QUESTION);
        ...
        idActionService.add(UIService.class.getCanonicalName(), ACTION_FILE_NEW);
        idActionService.add(UIService.class.getCanonicalName(),
                ACTION_FILE_OPEN);
        idActionService.add(UIService.class.getCanonicalName(),
                ACTION_FILE_SAVE);
        ...
        idActionService.add(UIService.class.getCanonicalName(), ACTION_DIR_OPEN);
        idActionService.add(UIService.class.getCanonicalName(),
                ACTION_DIR_DELETE);
    ...
    protected void deactivate(ComponentContext context) {
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_CLOSE);
        ...
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_RIGHT);
        ...
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_FIRST);
        idActionService.remove(UIService.class.getCanonicalName(),
                ACTION_PREVIOUS);
        ...
        idActionService.remove(UIService.class.getCanonicalName(),
                ACTION_WARNING);
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_ERROR);
        idActionService.remove(UIService.class.getCanonicalName(),
                ACTION_QUESTION);
        ...
        idActionService.remove(UIService.class.getCanonicalName(),
                ACTION_PREVIEW);
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_PRINT);
        ...
        idActionService.remove(UIService.class.getCanonicalName(), ACTION_ABOUT);
            ...
            buzzer = new Buzzer() {
                ...
                public void buzz(Component source) {
                    buzz(source,
                            ...
                            UIServiceImpl.class.getCanonicalName()).getString("NO_VALID"));
                }
    ...
    public void modifyDimensions(Window window) {
        ...
        Boolean recount = this.recount.get(window.getClass().getCanonicalName());
