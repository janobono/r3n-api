...
import sk.r3n.ui.component.field.MonthField;
import sk.r3n.ui.dialog.R3NOkCancelDialog;
import sk.r3n.ui.util.UIServiceManager;

public final class R3NMonthPanel extends JPanel implements
		R3NInputComponent<Date>, IdActionExecutor {

	private static final long serialVersionUID = 4210932144697096332L;

	private class MonthPickerDialog extends R3NOkCancelDialog {

		private static final long serialVersionUID = -8350104895524461077L;
		...
		public MonthPickerDialog() {
			...
			setTitle(ResourceBundle.getBundle(
					R3NMonthPanel.class.getCanonicalName()).getString("TITLE"));
		}
	...
	private void init(MonthField dateField) {
		...
		selectButton.addActionListener(new IdActionListener(UIService.class
				.getCanonicalName(), UIService.ACTION_SELECT, this));
