...
public class AppHelpImpl implements AppHelp {
	...
	private static final Logger LOGGER = Logger.getLogger(AppHelp.class
			.getCanonicalName());
			...
			if (desktop.isSupported(Desktop.Action.BROWSE)) {
				try {
					...
					LOGGER.log(
							Level.WARNING,
							ResourceBundle.getBundle(
									AppHelpImpl.class.getCanonicalName())
									.getString("SHOW_PAGE"), e);
				}
			}
		}
		LOGGER.log(Level.WARNING,
				ResourceBundle.getBundle(AppHelpImpl.class.getCanonicalName())
						.getString("SHOW_PAGE") + "[" + DIR + name + "]");
	}
