...
public class ConnectionPropertiesDialog extends R3NDialog {
    ...
    public ConnectionPropertiesDialog(Frame owner) {
        ...
        button.addActionListener(new IdAction(DbManagerService.class.getCanonicalName(), DbManagerService.ACTION_TEST, this));
        buttonPanel.addButton(button);
    ...
    public boolean init(Properties properties) {
        driverBox.setSelectedItem(properties.getProperty(
        ...
        if (groupId.equals(UIService.class.getCanonicalName())) {
            switch (actionId) {
                case UIService.ACTION_HELP:
                    DbManagerServiceImpl.appHelp.showHelp(ConnectionPropertiesDialog.class.getCanonicalName());
                    return;
                case UIService.ACTION_DEFAULT:
                    hostField.setText("127.0.0.1");
                    nameField.setText(DbManagerServiceImpl.context.getBundleContext().getProperty(DbManagerService.NAME));
